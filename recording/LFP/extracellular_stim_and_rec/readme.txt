...
process of stimulation and recording.  The cell has passive basilar dendrites,
active soma and axon, and dendrites that are also active but with reduced channel
densities.
...
is done AFTER SOLVE so that er reflects the effect of membrane current on 
