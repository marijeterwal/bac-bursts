...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_prop_size(_mechtype, 11, 4);
 	...
 	ivoc_help("help ?1 cadecay /media/caro/Daten/Studium/Master/Internship/Code&Data/Project-compact/model/channels/Bahl/i686/cadecay.mod\n");
