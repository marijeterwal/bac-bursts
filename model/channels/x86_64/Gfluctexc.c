...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 2);
 	...
 	ivoc_help("help ?1 Gfluct /home/ubuntu/Dropbox/NEURON/Project/Modelling/channels/x86_64/Gfluctexc.mod\n");
 ...
 v=_v;
{
 ...
 for (; t < _break; t += dt) {
 error =  oup();
 if(error){fprintf(stderr,"at line 141 in file Gfluctexc.mod:\n	SOLVE oup\n"); nrn_complain(_p); abort_run(error);}
