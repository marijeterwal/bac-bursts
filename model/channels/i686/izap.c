...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 1;
 	...
 	ivoc_help("help ?1 Izap /media/caro/Daten/Studium/Master/Internship/Code&Data/Project-compact/model/channels/i686/izap.mod\n");
...
#endif
{
 ...
 if ( on  == 0.0 ) {
     ...
     if ( f0  == 0.0  && f1  == 0.0 ) {
       ...
       i_tmp = amp * sin ( 2.0 * PI * ( t - delay ) * ( f0 + ( f1 - f0 ) * ( t - delay ) / ( 2.0 * dur ) ) * ( 0.001 ) ) ;
       }
